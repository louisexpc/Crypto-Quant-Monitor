...
def parse_timeframe_to_timedelta(timeframe: Literal["15m", "30m", "1h", "4h", "1d"]) -> pd.Timedelta:
    """
    ...
    raise ValueError(f"Unsupported timeframe format: {timeframe}. Expected like '15m'/'1h'/'1d'.")
